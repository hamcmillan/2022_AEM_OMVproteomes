...
# write_tsv(differential, "processed_data/pf_differential_abundance.tsv")
...
# #save/write differentially expressed to new directory
# write_tsv(t_sigenrich_comp, "processed_data/pf_sigenrich_comp.tsv")
# write_tsv(t_sigenrich_min, "processed_data/pf_sigenrich_min.tsv")
# write_tsv(enrich_and_fc_comp, "processed_data/pf_enrich_and_fc_comp.tsv")
# write_tsv(enrich_and_fc_min, "processed_data/pf_enrich_and_fc_min.tsv")
...
pst_abundance_go <- mutate(pst_abundance_go, mednorm_log_pst_complete_1 = pst_abundance_go$log__pst_complete_1 / summary(pst_abundance_go$avg_log_pst_complete)[["Median"]])
pst_abundance_go <- mutate(pst_abundance_go, mednorm_log_pst_complete_2 = pst_abundance_go$log__pst_complete_2 / summary(pst_abundance_go$avg_log_pst_complete)[["Median"]])
pst_abundance_go <- mutate(pst_abundance_go, mednorm_log_pst_complete_3 = pst_abundance_go$log__pst_complete_3 / summary(pst_abundance_go$avg_log_pst_complete)[["Median"]])

pst_abundance_go <- mutate(pst_abundance_go, mednorm_log_pst_minimal_1 = pst_abundance_go$log__pst_minimal_1 / summary(pst_abundance_go$avg_log_pst_complete)[["Median"]])
pst_abundance_go <- mutate(pst_abundance_go, mednorm_log_pst_minimal_2 = pst_abundance_go$log__pst_minimal_2 / summary(pst_abundance_go$avg_log_pst_complete)[["Median"]])
pst_abundance_go <- mutate(pst_abundance_go, mednorm_log_pst_minimal_3 = pst_abundance_go$log__pst_minimal_3 / summary(pst_abundance_go$avg_log_pst_complete)[["Median"]])

mednorm_log_for_plot <- pst_abundance_go %>% 
  dplyr::select(61:66) %>% 
...
pst_abundance_go <- mutate(pst_abundance_go, imp_mednorm_log_pst_complete_1 = imp_for_tests$mednorm_log_pst_complete_1)
pst_abundance_go <- mutate(pst_abundance_go, imp_mednorm_log_pst_complete_2 = imp_for_tests$mednorm_log_pst_complete_2)
pst_abundance_go <- mutate(pst_abundance_go, imp_mednorm_log_pst_complete_3 = imp_for_tests$mednorm_log_pst_complete_3)

pst_abundance_go <- mutate(pst_abundance_go, imp_mednorm_log_pst_minimal_1 = imp_for_tests$mednorm_log_pst_minimal_1)
pst_abundance_go <- mutate(pst_abundance_go, imp_mednorm_log_pst_minimal_2 = imp_for_tests$mednorm_log_pst_minimal_2)
pst_abundance_go <- mutate(pst_abundance_go, imp_mednorm_log_pst_minimal_3 = imp_for_tests$mednorm_log_pst_minimal_3)

temp <- pst_abundance_go

# z scores for each column
z_scores <- pst_abundance_go %>% 
...
z_scores <- rename(as_data_frame(z_scores),
                   z_imp_mednorm_log_pst_complete_1 = imp_mednorm_log_pst_complete_1,
                   z_imp_mednorm_log_pst_complete_2 = imp_mednorm_log_pst_complete_2,
                   z_imp_mednorm_log_pst_complete_3 = imp_mednorm_log_pst_complete_3,
                   z_imp_mednorm_log_pst_minimal_1 = imp_mednorm_log_pst_minimal_1,
                   z_imp_mednorm_log_pst_minimal_2 = imp_mednorm_log_pst_minimal_2,
                   z_imp_mednorm_log_pst_minimal_3 = imp_mednorm_log_pst_minimal_3,
                   )

pst_abundance_go <- cbind(pst_abundance_go, z_scores)
...
zp <- rename(as_data_frame(zp),
                   zp_imp_mednorm_log_pst_complete_1 = z_imp_mednorm_log_pst_complete_1,
                   zp_imp_mednorm_log_pst_complete_2 = z_imp_mednorm_log_pst_complete_2,
                   zp_imp_mednorm_log_pst_complete_3 = z_imp_mednorm_log_pst_complete_3,
                   zp_imp_mednorm_log_pst_minimal_1 = z_imp_mednorm_log_pst_minimal_1,
                   zp_imp_mednorm_log_pst_minimal_2 = z_imp_mednorm_log_pst_minimal_2,
                   zp_imp_mednorm_log_pst_minimal_3 = z_imp_mednorm_log_pst_minimal_3,
             )

pst_abundance_go <- cbind(pst_abundance_go, zp)
...
pst_comp_sig <- rowSums(zp[1:3] <= 0.05, na.rm = TRUE)
pst_min_sig <- rowSums(zp[4:6] <= 0.05, na.rm = TRUE)

#append these lists to main table
#if 2 or more significant values, add to new data table "sig_within"
pst_abundance_go <- cbind(pst_abundance_go, pst_comp_sig)
pst_abundance_go <- cbind(pst_abundance_go, pst_min_sig)
sig_within <- data.frame(filter(pst_abundance_go, pst_comp_sig >= 2 | pst_min_sig >= 2))

#save/write differentially expressed to new directory
write_tsv(sig_within, "processed_data/pst_sig_z_abundance.tsv")
...
for(i in 1:nrow(pst_abundance_go)){
  complete = c(pst_abundance_go[i, 67:69])
  minimal = c(pst_abundance_go[i, 70:72])
...
pst_abundance_go <- mutate(pst_abundance_go, avg_imp_mednorm_log_complete = avg_imp_mednorm_log_complete)
pst_abundance_go <- mutate(pst_abundance_go, avg_imp_mednorm_log_minimal = avg_imp_mednorm_log_minimal)
...
pst_abundance_go <- mutate(pst_abundance_go, fc_comp_vs_median = vp$fc_comp)
pst_abundance_go <- mutate(pst_abundance_go, nlog10_p_avg_mednorm_comp = vp$log_p_comp)
pst_abundance_go <- mutate(pst_abundance_go, log2_fc_comp_vs_median = vp$log2_fc_comp)

pst_abundance_go <- mutate(pst_abundance_go, fc_min_vs_median = vp$fc_min)
pst_abundance_go <- mutate(pst_abundance_go, nlog10_p_avg_mednorm_min = vp$log_p_min)
pst_abundance_go <- mutate(pst_abundance_go, log2_fc_min_vs_median = vp$log2_fc_min)
...
# write new file with complete abundance, go terms, and significance testing
write_tsv(pst_abundance_go, "processed_data/pst_z_processed_abundance_go.txt")

# get list of significant difference by z score comp and min vs median
z_sigdif <- pst_abundance_go %>% 
  dplyr::select("gi_number", "accession", "description", contains("imp_mednorm_log_pst"), 
                "pst_comp_sig", "pst_min_sig", contains("avg_imp_mednorm"), "fc_comp_vs_median", 
                contains("nlog10_p_avg_mednorm"), "log2_fc_comp_vs_median", "fc_min_vs_median", 
                "log2_fc_min_vs_median") %>% 
  filter(pst_comp_sig >= 2 | pst_min_sig >= 2)

z_sigenrich_min <- z_sigdif %>% 
  filter(pst_min_sig >= 2 & avg_imp_mednorm_log_minimal > median(avg_imp_mednorm_log_minimal))
z_sigenrich_comp <- z_sigdif %>% 
  filter(pst_comp_sig >= 2 & avg_imp_mednorm_log_complete > median(avg_imp_mednorm_log_complete))
...
# write to files
write_tsv(z_sigenrich_comp, "processed_data/pst_z_sigenrich_comp.tsv")
write_tsv(z_sigenrich_min, "processed_data/pst_z_sigenrich_min.tsv")
write_tsv(z_enrich_and_fc_comp, "processed_data/pst_z_enrich_and_fc_comp.tsv")
write_tsv(z_enrich_and_fc_min, "processed_data/pst_z_enrich_and_fc_min.tsv")
