...
abundance <- read_tsv("processed_data/pf_sig_z_abundance.tsv")
...
kegg <- abundance %>% 
  dplyr::select("gi_number", "description", "imp_mednorm_log_pf_complete_1", 
                ...
                "imp_mednorm_log_pf_minimal_3", "pf_comp_sig", "pf_min_sig") %>% 
...
kterm_sig_Pfcomp <- k_term_fisher %>% 
...
kterm_sig_Pfcomp_sortbyabund <- k_term_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
...
pathA_sig_Pfcomp <- k_path_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  #slice(1:10) %>% 
...
pathA_sig_Pfcomp_sortbyabund <- k_path_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  #slice(1:10) %>% 
...
pathB_sig_Pfcomp <- k_pathB_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
...
pathB_sig_Pfcomp_sortbyabund <- k_pathB_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:15) %>% 
...
pathC_sig_Pfcomp <- k_pathC_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  filter(adj_fisher_p <= 0.05) %>% 
...
pathC_sig_Pfcomp_sortbyabund <- k_pathC_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  filter(adj_fisher_p <= 0.05) %>% 
...
kterm_sig_Pfmin_sortbyabund <- k_term_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:10) %>% 
...
pathA_sig_Pfmin_sortbyabund <- k_path_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  #slice(1:10) %>% 
...
pathB_sig_Pfmin <- k_pathB_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  filter(adj_fisher_p <= 0.05) %>% 
...
pathB_sig_Pfmin_sortbyabund <- k_pathB_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:15) %>% 
...
pathC_sig_Pfmin <- k_pathC_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  filter(adj_fisher_p <= 0.05) %>% 
...
pathC_sig_Pfmin_sortbyabund <- k_pathC_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:15) %>% 
...
######## KEGG - sig enrich Pf complete by z score, sig in at least two of three replicates ################
abundance <- read_tsv("processed_data/pf_z_sigenrich_comp.tsv")
...
kterm_sigenrich_Pfcomp <- k_term_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  slice(1:10) %>% 
...
kterm_sigenrich_Pfcomp_sortbyabund <- k_term_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:10) %>% 
...
pathA_sigenrich_Pfcomp <- k_path_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  #slice(1:10) %>% 
...
pathA_sigenrich_Pfcomp_sortbyabund <- k_path_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  #slice(1:10) %>% 
...
pathB_sigenrich_Pfcomp <- k_pathB_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  filter(adj_fisher_p <= 0.05) %>% 
...
pathB_sigenrich_Pfcomp_sortbyabund <- k_pathB_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:15) %>% 
...
pathC_sigenrich_Pfcomp <- k_pathC_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>%
  filter(adj_fisher_p <= 0.05) %>% 
...
pathC_sigenrich_Pfcomp_sortbyabund <- k_pathC_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:15) %>% 
...
######## KEGG - sig enrich Pf minimal by z score, sig in at least two of three replicates ################
abundance <- read_tsv("processed_data/pf_z_sigenrich_min.tsv")
...
kterm_sigenrich_Pfmin <- k_term_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  slice(1:10) %>% 
...
kterm_sigenrich_Pfmin_sortbyabund <- k_term_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:10) %>% 
...
pathA_sigenrich_Pfmin <- k_path_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  #slice(1:10) %>% 
...
pathA_sigenrich_Pfmin_sortbyabund <- k_path_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  #slice(1:10) %>% 
...
pathB_sigenrich_Pfmin <- k_pathB_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  filter(adj_fisher_p <= 0.05) %>% 
...
pathB_sigenrich_Pfmin_sortbyabund <- k_pathB_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:15) %>% 
...
pathC_sigenrich_Pfmin <- k_pathC_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  filter(adj_fisher_p <= 0.05) %>% 
...
pathC_sigenrich_Pfmin_sortbyabund <- k_pathC_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:15) %>% 
...
######## KEGG - sig enrich and FC higher Pf complete by z score, sig in at least two of three replicates ################
abundance <- read_tsv("processed_data/pf_z_enrich_and_fc_comp.tsv")
...
kterm_fc_sigenrich_Pfcomp <- k_term_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  slice(1:10) %>% 
...
kterm_fc_sigenrich_Pfcomp_sortbyabund <- k_term_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:10) %>% 
...
pathA_fc_sigenrich_Pfcomp <- k_path_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  #slice(1:10) %>% 
...
pathA_fc_sigenrich_Pfcomp_sortbyabund <- k_path_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  #slice(1:10) %>% 
...
pathB_fc_sigenrich_Pfcomp <- k_pathB_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  filter(adj_fisher_p <= 0.05) %>% 
...
pathB_fc_sigenrich_Pfcomp_sortbyabund <- k_pathB_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:15) %>% 
...
pathC_fc_sigenrich_Pfcomp <- k_pathC_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  filter(adj_fisher_p <= 0.05) %>% 
...
pathC_fc_sigenrich_Pfcomp_sortbyabund <- k_pathC_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:15) %>% 
...
######## KEGG - sig enrich and FC higher Pf minimal by z score, sig in at least two of three replicates ################
abundance <- read_tsv("processed_data/pf_z_enrich_and_fc_min.tsv")
...
kterm_fc_sigenrich_Pfmin <- k_term_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  slice(1:10) %>% 
...
kterm_fc_sigenrich_Pfmin_sortbyabund <- k_term_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:10) %>% 
...
pathA_fc_sigenrich_Pfmin <- k_path_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  #slice(1:10) %>% 
...
pathA_fc_sigenrich_Pfmin_sortbyabund <- k_path_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  #slice(1:10) %>% 
...
pathB_fc_sigenrich_Pfmin <- k_pathB_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  filter(adj_fisher_p <= 0.05) %>% 
...
pathB_fc_sigenrich_Pfmin_sortbyabund <- k_pathB_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:15) %>% 
...
pathC_fc_sigenrich_Pfmin <- k_pathC_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(adj_fisher_p) %>% 
  filter(adj_fisher_p <= 0.05) %>% 
...
pathC_fc_sigenrich_Pfmin_sortbyabund <- k_pathC_fisher %>% 
  mutate(expected_count = (N.y/sum(N.y))*sum(N.x, na.rm = TRUE)) %>% 
  rename(actual_count = N.x) %>% 
  arrange(-actual_count) %>% 
  slice(1:15) %>% 
...
################ print figs ################
pdf("figures_kegg_Pf_Dataset.pdf")
kterm_sig_Pfcomp
pathA_sig_Pfcomp
pathB_sig_Pfcomp
pathC_sig_Pfcomp
...
pathB_sig_Pfmin
pathC_sig_Pfmin
kterm_sigenrich_Pfcomp
pathA_sigenrich_Pfcomp
pathB_sigenrich_Pfcomp
pathC_sigenrich_Pfcomp
kterm_sigenrich_Pfmin
pathA_sigenrich_Pfmin
pathB_sigenrich_Pfmin
pathC_sigenrich_Pfmin
kterm_fc_sigenrich_Pfcomp
pathA_fc_sigenrich_Pfcomp
pathB_fc_sigenrich_Pfcomp
pathC_fc_sigenrich_Pfcomp
kterm_fc_sigenrich_Pfmin
pathA_fc_sigenrich_Pfmin
pathB_fc_sigenrich_Pfmin
pathC_fc_sigenrich_Pfmin
kterm_sig_Pfcomp_sortbyabund
pathA_sig_Pfcomp_sortbyabund
pathB_sig_Pfcomp_sortbyabund
pathC_sig_Pfcomp_sortbyabund
kterm_sig_Pfmin_sortbyabund
pathA_sig_Pfmin_sortbyabund
pathB_sig_Pfmin_sortbyabund
pathC_sig_Pfmin_sortbyabund
kterm_sigenrich_Pfcomp_sortbyabund
pathA_sigenrich_Pfcomp_sortbyabund
pathB_sigenrich_Pfcomp_sortbyabund
pathC_sigenrich_Pfcomp_sortbyabund
kterm_sigenrich_Pfmin_sortbyabund
pathA_sigenrich_Pfmin_sortbyabund
pathB_sigenrich_Pfmin_sortbyabund
pathC_sigenrich_Pfmin_sortbyabund
kterm_fc_sigenrich_Pfcomp_sortbyabund
pathA_fc_sigenrich_Pfcomp_sortbyabund
pathB_fc_sigenrich_Pfcomp_sortbyabund
pathC_fc_sigenrich_Pfcomp_sortbyabund
kterm_fc_sigenrich_Pfmin_sortbyabund
pathA_fc_sigenrich_Pfmin_sortbyabund
pathB_fc_sigenrich_Pfmin_sortbyabund
pathC_fc_sigenrich_Pfmin_sortbyabund
dev.off()

svglite::svglite("figures/Pf_comp_KEGG_B.svg", height = 3, width = 5)
pathB_sigenrich_Pfcomp
dev.off()

svglite::svglite("figures/Pf_comp_KEGG_C.svg", height = 3, width = 5)
pathC_sigenrich_Pfcomp
dev.off()

svglite::svglite("figures/Pf_min_KEGG_B.svg", height = 3, width = 5)
pathB_sigenrich_Pfmin
dev.off()

svglite::svglite("figures/Pf_min_KEGG_C.svg", height = 3, width = 5)
pathC_sigenrich_Pfmin
dev.off()

svglite::svglite("figures/Pf_fccomp_KEGG_B.svg", height = 3, width = 5)
pathB_fc_sigenrich_Pfcomp
dev.off()

svglite::svglite("figures/Pf_fccomp_KEGG_C.svg", height = 3, width = 5)
pathC_fc_sigenrich_Pfcomp
dev.off()

svglite::svglite("figures/Pf_fcmin_KEGG_B.svg", height = 3, width = 5)
pathB_fc_sigenrich_Pfmin
dev.off()

svglite::svglite("figures/Pf_fcmin_KEGG_C.svg", height = 3, width = 5)
pathC_fc_sigenrich_Pfmin
dev.off()